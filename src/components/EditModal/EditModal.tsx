...
import { v4 } from 'uuid';
import { header, modalWindow, wrapper, title, input, buttons, updateButton, deleteButton, closeButton } from './EditModal.css';
...
const EditModal = () => {
  ...
  const handleDiscriptionChange = (e: ChangeEvent<HTMLInputElement>) => {
    setData({
      ...data,
      task: {
        ...data.task,
